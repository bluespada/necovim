...
_G.packer_plugins = {
  ...
  ["completion-nvim"] = {
    loaded = true,
    path = "/home/draco/.local/share/nvim/site/pack/packer/start/completion-nvim"
  },
  ["dashboard-nvim"] = {
    loaded = true,
  ...
  ["flutter-tools.nvim"] = {
    loaded = true,
    path = "/home/draco/.local/share/nvim/site/pack/packer/start/flutter-tools.nvim"
  },
  gruvbox = {
    loaded = true,
  ...
  ["lexima.vim"] = {
    loaded = true,
    path = "/home/draco/.local/share/nvim/site/pack/packer/start/lexima.vim"
  },
  ["lspkind-nvim"] = {
    loaded = true,
    path = "/home/draco/.local/share/nvim/site/pack/packer/start/lspkind-nvim"
  },
  ["lspsaga.nvim"] = {
    loaded = true,
    path = "/home/draco/.local/share/nvim/site/pack/packer/start/lspsaga.nvim"
  },
  ["lualine.nvim"] = {
    loaded = true,
  ...
  ["nvim-dap"] = {
    loaded = true,
    path = "/home/draco/.local/share/nvim/site/pack/packer/start/nvim-dap"
  },
  ["nvim-lsp-installer"] = {
    loaded = true,
    path = "/home/draco/.local/share/nvim/site/pack/packer/start/nvim-lsp-installer"
  },
  ["nvim-lspconfig"] = {
    loaded = true,
    path = "/home/draco/.local/share/nvim/site/pack/packer/start/nvim-lspconfig"
  },
  ["nvim-lspinstall"] = {
    loaded = true,
    path = "/home/draco/.local/share/nvim/site/pack/packer/start/nvim-lspinstall"
  },
  ["nvim-reload"] = {
    loaded = true,
  ...
  ["ranger.vim"] = {
    loaded = true,
    path = "/home/draco/.local/share/nvim/site/pack/packer/start/ranger.vim"
  },
  ["scrollbar.nvim"] = {
    loaded = true,
  ...
  ["telescope.nvim"] = {
    loaded = true,
    path = "/home/draco/.local/share/nvim/site/pack/packer/start/telescope.nvim"
  },
  ["twilight.nvim"] = {
    loaded = true,
  ...
  ["vim-fish-syntax"] = {
    loaded = true,
    path = "/home/draco/.local/share/nvim/site/pack/packer/start/vim-fish-syntax"
  },
  ["vim-fugitive"] = {
    loaded = true,
  ...
  ["vim-move"] = {
    loaded = true,
    path = "/home/draco/.local/share/nvim/site/pack/packer/start/vim-move"
  },
  ["vim-smoothie"] = {
    loaded = true,
  ...
  vimwiki = {
    loaded = true,
    path = "/home/draco/.local/share/nvim/site/pack/packer/start/vimwiki"
  },
  ["zen-mode.nvim"] = {
    loaded = true,
